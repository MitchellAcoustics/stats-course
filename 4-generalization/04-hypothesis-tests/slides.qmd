...
![](4-generalization/04-hypothesis-tests/images/two-sided.png){fig-width="400" fig-align="center"}
...
## {background-image="4-generalization/04-hypothesis-tests/images/pic-5.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-6.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-7.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-8.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-9.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-10.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-11.jpg" background-size="contain"}

## {background-image="4-generalization/04-hypothesis-tests/images/pic-12.jpg" background-size="contain"}
...
```{r, fig.height=4}
ggplot(class_survey, aes(x = mts_beach, fill = warm_fav)) +
...
```{r}
class_survey %>%
  specify(response = warm_fav, explanatory = mts_beach, success = "TRUE")
```
...
class_survey %>%
  ...
  hypothesize(null = "independence") %>%
  generate(reps = 1, type = "permute") # a second shuffle
```
...
class_survey %>%
  ...
  hypothesize(null = "independence") %>%
  generate(reps = 1, type = "permute") # a third shuffle
```
