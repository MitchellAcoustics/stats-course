...
![](4-generalization/04-hypothesis-tests/images/northampton-va.jpg){fig-align="center" width="400"}
...
![](4-generalization/04-hypothesis-tests/images/shift-deaths.jpeg){fig-align="center" width="550"}
...
set.seed(3224)
code_blue <- read_csv(
  "https://raw.githubusercontent.com/MitchellAcoustics/stats-course/refs/heads/main/4-generalization/04-hypothesis-tests/code_blue.csv"
) %>%
  slice_sample(prop = 1)
code_blue
```
...
[^2]: The technical notion that motivates the use of shuffling is a slightly more general notion than independence called exchangability. The distinction between these two related concepts is a topic in a course in probability.
...
![](4-generalization/04-hypothesis-tests/images/infer-hypothesize.png){fig-align="center" width="440"}
