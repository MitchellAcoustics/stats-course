...
![](4-generalization/06-wrong-by-design/images/ppk-as-ht.png)
...
ppk <- ppk |>
  mutate(
    support_before = Q18_words %in%
      c("Somewhat support", "Strongly support", "Very strongly support")
  )
```
...
ggplot(df, aes(x = x, y = y)) +
  ...
  stat_function(
    fun = dnorm,
    args = list(mean = 75 / 2, sd = sqrt(74 / 4)),
    col = "goldenrod",
    lwd = 1.2
  )
```
...
knitr::include_graphics(
  "4-generalization/06-wrong-by-design/images/covid-barchart.png"
)
```
...
```{r, out.width="100%", fig.align='center'}
knitr::include_graphics(
  "4-generalization/06-wrong-by-design/images/covid-positivity.png"
)
```
...
```{r, out.width="100%", fig.align='center'}
knitr::include_graphics(
  "4-generalization/06-wrong-by-design/images/decision-errors-table.jpg"
)
```
...
```{r, out.width="100%", fig.align='center'}
knitr::include_graphics("4-generalization/06-wrong-by-design/images/decision-error-rates.jpg")
```
...
```{r, out.width="70%"}
knitr::include_graphics("4-generalization/06-wrong-by-design/images/PeopleBirding.jpeg")
```
